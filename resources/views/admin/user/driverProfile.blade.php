            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="{{ isset($user) ? asset('storage/' . $user->user_image) : asset('assets/admin/img/messages-3.jpg') }}"
                            alt="Profile">
                        <h2>{{ $user->first_name }} {{ $user->last_name }}</h2>
                        <h3>{{ $user->getRoleNames()->first() ?? 'No Role Assigned' }}</h3>
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#driver-document">Document</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $user->country->name ?? '' }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Address</div>
                                    <div class="col-lg-9 col-md-8">{{ $user->address }},
                                        {{ $user->state->state_name ?? '' }}, {{ $user->city->city_name ?? '' }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade pt-3 profile-overview" id="driver-document">
                                <h5 class="card-title">Documents</h5>
                                @foreach ($user->documents as $key => $doc)
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">{{ $doc->identity_type ?? '' }}</div>
                                            ...
                                            @if ($doc->document)
                                                ...
                                                @if (in_array(strtolower($extension), ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'webp']))
                                                    <img src="{{ asset('storage/' . $doc->document) }}"
                                                        alt="Document Image" class="img-fluid me-2 "
                                                        style="max-width: 150px; border-radius: 5px; ">
                                                    <img src="{{ asset('storage/' . $doc->document_back) }}"
                                                        alt="Document Image" class="img-fluid ms-3"
                                                        style="max-width: 150px; border-radius: 5px;">
